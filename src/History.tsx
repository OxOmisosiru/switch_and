...
const CONFIG_MESSAGES: Record<string, string> = {
  "person:1": "岩で隠れている回数に従って船を動かし、迷路を解きましょう。最短で進むと通る文字は「こうか」です。",
  "person:2": "岩で隠れている回数に従って船を動かし、迷路を解きましょう。最短で進むと通る文字は「こうかい」です。",
  "person:3": "岩で隠れている回数に従って船を動かし、迷路を解きましょう。最短で進むと通る文字は「ちまき」です。",

  "tablet:1": "左のイラストはもやい結び、右のイラストはじざい結びを表しています。下の文章は「もやしはやさいの1種」となるので、答えは「もやし」です。",

  "desk:1": "ペットボトルに入っているのはコーラです。キャップを外して一時間(1h)も経てば炭酸が抜けぬるくなるため、前は「たんさん水」「つめたい」「あまい」、後は「水」「ぬるい」「あまい」、真ん中は「こーら」が埋まり、答えは「あんこーる」です。",

  "chair:2": "問題文の「おわりで」は尾張弁で読むことを表しています。イラストは左から「ざらいた」「おくうん」「だだくさ」「かいもん」を表しているため、答えは「らくだい」です。",
  "chair:4": "問題文の「おわりで」は尾張弁で読むことを表しています。イラストは左から「ざらいた」「おくうん」「だだくさ」「かいもん」を表しているため、答えは「たんさん」です。",

  "switch:1": "問一：Bad(Because vehicles required to make a two-stage right turn cannot turn right directly.)\n問二：×（昼の道も危険だから）\n問三：⚪︎\nなので、答えは「ばっどばつまる」です。",

  "partition:3": "青の枠にはパーム、赤の枠にはダブルリフトが入ります。青の3文字目、赤の2文字目、クを拾って答えは「るーく」です。",
  "partition:4": "青の枠にはパーム、赤の枠にはダブルリフトが入ります。青の4文字目、赤の2文字目、クを拾って答えは「りーく」です。",

  "stop:8": "右足を出す→左足を出す→これらを繰り返す、ことで歩くことができます。よってAに右、Bに足、Cに左、Dに歩が埋まるため、足・歩の漢字の上半分、めを拾って答えは「くちどめ」です。",

  "rubik:0": "黒い斜線は英単語を逆にする法則性です。MYの逆はYOUR、AM AREの逆はISであるため、上二つは「ゆあみ≒ぎょうずい」となり意味が通ります。ONの逆はOFFであるため答えは「おふろ」です。",
  "rubik:1": "黒い斜線は英単語を逆にする法則性です。MYの逆はYOUR、AM AREの逆はISであるため、上二つは「ゆあみ≒ぎょうずい」となり意味が通ります。INの逆はOUTであるため答えは「あうとろ」です。",

  "arubeki:0": "0の呼び方としては「ぜろ」「れい」が、下のイラストの呼び方としては「どりる」が埋まります。バツの数が0個のマスに入る文字、ろ・い・りを並び替えることで答えは「いろり」です。",
  "arubeki:1": "0の言い方としては「いち」「わん」が、下のイラストの言い方としては「どりる」が埋まります。バツの数が1個のマスに入る文字、い・わ・ど・るを並び替えることで答えは「わいるど」です。",
};
